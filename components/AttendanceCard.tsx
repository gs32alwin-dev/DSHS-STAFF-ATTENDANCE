  ...
  return (
    <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm flex items-center justify-between transition-all hover:shadow-md">
      <div className="flex items-center gap-4">
        <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${isSignIn ? 'bg-emerald-100 text-emerald-600' : 'bg-rose-100 text-rose-600'}`}>
      ...
      <div className="text-right">
        ...
        <span className={`text-[10px] px-2 py-0.5 rounded-full font-bold uppercase ${isSignIn ? 'bg-emerald-500 text-white' : 'bg-rose-500 text-white'}`}>
